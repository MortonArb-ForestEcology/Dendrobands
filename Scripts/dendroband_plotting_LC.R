...
#2017 data was noisy. Creating subset starting at 2018 just in case
...
png("~/GitHub/Dendrobands/LC_Figures//LCDendoband_TotalDistanceFromCollar_2017-2019.png")
ggplot(data=dendroband[!is.na(dendroband$dist_from_collar),]) + #Set basic plot parameters
  ...
  ggtitle("LC Total Measured Distance from Collar to Line 2017-2019") +
...
png("~/GitHub/Dendrobands/LC_Figures//LCDendoband_TotalDistanceFromCollar_2018-2019.png")
ggplot(data=after2017[!is.na(after2017$dist_from_collar),]) + #Set basic plot parameters
  ...
  ylab(expression("Distance from Collar (mm)"))+
  xlab(expression("Date Observed")) +
  ggtitle("LC Total Measured Distance from Collar to Line 2018-2019") +
  scale_x_datetime(date_breaks = "2 months", labels = date_format("%b %Y"))+
  scale_color_discrete() +
  facet_wrap(~taxon, ncol=2, scales = "free") #Specify panels
dev.off()
...
#Boxplot for total distance from collar 2018-2019
png("~/GitHub/Dendrobands/LC_Figures//LCDendoband_TotalDistancefromCollar_Boxplot_BySpecies.png")
ggboxplot(after2017, x = "taxon", y = "dist_from_collar", 
          color = "taxon",
          legend = "none",
          ylab = "Distance From Collar (mm)", xlab = "Taxon", 
...
#Growth per day from 2018-2019

png("~/GitHub/Dendrobands/LC_Figures//LCDendoband_GrowthPerDay2018-2019_Boxplot_Species.png")
ggboxplot(growth_df3, x = "taxon", y = "mm_day", 
          color = "taxon",
          legend = "none",
...
#Comparing means of growth per day across species
tapply(growth_df3$mm_day, growth_df3$taxon, mean)
tapply(growth_df3$mm_day, growth_df3$taxon, sd)
res.aov <- aov(mm_day ~ taxon, data = growth_df2)
summary(res.aov)

#Plotting growth per day from 2017-2019
png("~/GitHub/Dendrobands/LC_Figures//LCDendoband_GrowthPerDay_2017-2019_BySpecies.png")
ggplot(data=growth_df2) + #Set basic plot parameters
  ...
  ggtitle("LC Growth per day (mm) 2017-2019") +
...
#Subsetting growth per day from 2018-2019
png("~/GitHub/Dendrobands/LC_Figures//LCDendoband_GrowthPerDay_2018-2019_BySpecies.png")
